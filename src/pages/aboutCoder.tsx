...
export default function AboutCoder() {
  return (
    <div className="about-coder-container">
  <div className="about-card">
    <img className="found-me-image" src={GOOF_IMG_SRC} alt="Pic of me" />

    <div className="about-text">
      <h2>About the Developer</h2>
      <p>My name is Nessy or Morgan and I wrote this program between my two years as a ridges counselor. 
         ...
         Ridges means so much to me and I hope that it continues to grow. My time on ridges was some of the best of my life.</p>
      <p>I got to lead ridges with my best friend (now fiance) and I really couldn't have gotten luckier. 
         Hopefully you get a life long friend!</p>
    </div>
  </div>
</div>
